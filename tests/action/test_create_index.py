    ...
    return Schema({
        'Document1': Schema.Document(
            ...
            indexes={
                ...
                'index2': {'fields': [('field2', pymongo.ASCENDING)]}
            },
        ),
...
class TestCreateIndex:
    def test_forward__should_create_index(self, test_db, left_schema):
        ...
        assert indexes[0]['name'] == 'my_index'
    ...
    def test_forward__if_name_param_does_not_specified__should_create_with_autogenerated_name(
        ...
        action = CreateIndex('Document1', 'field1_1_field2_geoHaystack', fields=fields,
                             sparse=True)
        action.prepare(test_db, left_schema, MigrationPolicy.strict)
    ...
    def test_forward__if_index_with_such_fields_spec_already_exist__should_raise_error(
            self, test_db, left_schema
    ):
        fields = [('field2', pymongo.DESCENDING)]
        test_db['document1'].create_index(fields, name='old_index', sparse=True)
        action = CreateIndex('Document1', 'test_index', fields=fields,
                             name='test_index', sparse=False)
        action.prepare(test_db, left_schema, MigrationPolicy.strict)
    ...
    def test_backward__if_name_param_does_not_specified__should_drop_by_fields_spec(
        ...
        fields = (('field1', pymongo.ASCENDING), ('field2', pymongo.GEOHAYSTACK))
        action = CreateIndex('Document1', 'field1_1_field2_geoHaystack', fields=fields, sparse=True)
        action.prepare(test_db, left_schema, MigrationPolicy.strict)
        action.run_forward()
    ...
    def test_prepare__if_document_not_in_schema__should_raise_error(self, test_db, left_schema):
        ...
        action = CreateIndex('UnknownDocument', 'index3', fields=fields, sparse=True)
    ...
    def test_prepare__if_index_is_in_schema__should_raise_error(self, test_db, left_schema):
        ...
        action = CreateIndex('Document1', 'index3', fields=fields,
                             name='test_index', sparse=False)
